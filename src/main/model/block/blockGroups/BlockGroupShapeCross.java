...
public class BlockGroupShapeCross extends BlockGroup{

    public BlockGroupShapeCross(List<Block> newActiveBlocks, Cell centerTopCell, int index, MainJFX main) {
    ...
    public int tryPlaceBlocksInShape(Direction direction, List<Block> activeBlocks, Cell origin) {
        ...
        newCells.add(CellDirectionHelper.getCellAtDirection(temp, DirectionHelper.getRotatedDirection(direction,true)));
        newCells.add(CellDirectionHelper.getCellAtDirection(temp, DirectionHelper.getRotatedDirection(direction, false)));
