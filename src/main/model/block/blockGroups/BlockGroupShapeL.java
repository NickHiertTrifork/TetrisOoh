...
public class BlockGroupShapeL extends BlockGroup {

    public BlockGroupShapeL(List<Block> newActiveBlocks, Cell centerTopCell, int index, MainJFX main) {
    ...
    public int tryPlaceBlocksInShape(Direction direction, List<Block> activeBlocks, Cell origin) {
        ...
        temp = CellDirectionHelper.getCellAtDirection(temp, DirectionHelper.getRotatedDirection(direction, false));
        newCells.add(temp);
